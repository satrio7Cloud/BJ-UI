            ...
            <main className="flex-1 pt-24 pb-20 px-4 sm:px-6 lg:px-8">
                <div className="max-w-7xl mx-auto">
                    ...
                    {checkoutData ? (
                        ...
                        <>
                            {/* Hero Banner Section */}
                            <div className="relative bg-gradient-to-r from-[#031E15] via-[#042C20] to-[#0A3D2F] rounded-3xl overflow-hidden px-8 py-12 md:py-16 text-white mb-10 shadow-lg">
                                {/* Silhouette Image */}
                                <img 
                                    src={heroImg} 
                                ...
                                <div className="flex flex-wrap gap-3">
                                    {categories.map((category) => (
                                        <button
                                            ...
                                            className={`flex items-center gap-2 px-5 py-2.5 rounded-full text-sm font-semibold transition-all cursor-pointer border ${

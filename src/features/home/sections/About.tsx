...
export default function About() {
  return (
    <section id="tentang" className="py-24 relative overflow-hidden bg-white">
      ...
      <div className="absolute top-0 right-0 -mr-20 -mt-20 w-[500px] h-[500px] bg-emerald-50 rounded-full blur-3xl opacity-60 pointer-events-none"></div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
          ...
          <div className="space-y-8">
            ...
            <p className="text-slate-600 text-lg leading-relaxed">
              ...
              proses, memberikan Anda ketenangan pikiran tanpa harus antri berjam-jam.
            </p>
            ...
            <div className="flex gap-4 pt-4">
               <div className="flex items-center gap-3 bg-slate-50 border border-slate-200 px-5 py-3 rounded-2xl">
                 ...
                 <div className="text-sm font-bold text-slate-900">Proses Kilat</div>
               </div>
               <div className="flex items-center gap-3 bg-slate-50 border border-slate-200 px-5 py-3 rounded-2xl">
                 <div className="w-10 h-10 bg-emerald-100 rounded-full flex items-center justify-center text-emerald-600 shrink-0">
                    <ShieldCheck size={20} />
                 </div>
                 <div className="text-sm font-bold text-slate-900">Terjamin Aman</div>
               </div>
            </div>
          </div>
          ...
          <div className="relative">
            <div className="absolute inset-0 bg-gradient-to-br from-emerald-400 to-teal-500 rounded-[2.5rem] transform rotate-3 scale-[1.02] opacity-20 blur-lg"></div>
            ...
            <div className="bg-white rounded-[2.5rem] border border-slate-200/60 shadow-2xl shadow-slate-200 p-8 md:p-10 relative z-10 space-y-6">
              ...
              <div className="border-b border-slate-100 pb-5 mb-6">
                 <h3 className="text-2xl font-bold text-slate-800">Kenapa Memilih Kami?</h3>
                 <p className="text-slate-500 text-sm mt-2">Nilai unggul yang selalu kami berikan kepada setiap pelanggan.</p>
              </div>

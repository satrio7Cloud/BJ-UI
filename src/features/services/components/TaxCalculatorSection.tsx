...
export default function TaxCalculatorSection() {
  ...
  const [formData, setFormData] = useState({
    ...
    tipeLayanan: "tahunan" as "tahunan" | "5tahunan" | "baliknama",
  });
  ...
  const handleCalculate = (e: React.FormEvent) => {
    ...
    toast.success("Kalkulasi & Validasi Data Berhasil!");
  };

  const handleProceedToCheckout = () => {
    if (!calculatedResult) return;

    // Navigasi ke halaman checkout dengan membawa state pre-filled data
    navigate("/checkout", {
      state: {
        prefill: {
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-3">
                  <button
                    ...
                    className={`py-3 px-4 rounded-2xl text-sm font-bold flex items-center justify-center gap-2 border transition-all cursor-pointer ${
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-2">
                  {[
                    ...
                    { key: "baliknama", label: "Balik Nama / Mutasi" },
                  ].map((t) => (
                    <button
                      key={t.key}
                      type="button"
              ...
              {calculatedResult ? (
                <div className="space-y-6">
                  ...
                  <div className="space-y-3 border-b border-slate-800 pb-5 text-sm">
                    ...
                    <div className="flex justify-between items-center text-slate-300">
                      <span>Jasa Pengurusan DTerazz</span>
                      <span className="font-bold text-white">

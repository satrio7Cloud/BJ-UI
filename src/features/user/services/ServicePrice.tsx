  ...
  return (
    <section className="relative py-24 overflow-hidden">
      ...
      <div className="relative max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center z-10">
        <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-emerald-100 border border-emerald-200 text-emerald-700 text-sm font-bold tracking-wide uppercase mb-6 shadow-sm">
          <Sparkles size={16} />
        ...
        <div className="flex flex-wrap justify-center gap-4 mb-12">
          <div className="flex items-center gap-2 px-4 py-2 bg-white rounded-xl border border-slate-200 text-slate-700 text-sm font-medium shadow-sm">
        ...
        <button
          ...
          className="group relative inline-flex items-center justify-center gap-3 px-8 py-4 bg-[#0A3222] hover:bg-[#12412D] text-white font-extrabold text-lg rounded-2xl shadow-lg shadow-emerald-900/20 transition-all duration-300 cursor-pointer overflow-hidden"
        >

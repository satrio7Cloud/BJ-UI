            ...
            <div className="bg-white dark:bg-slate-900 rounded-2xl p-6 shadow-sm border border-slate-100 dark:border-slate-800 transition-colors">
                {activeTab === "brands" ? (
                                        ...
                                        <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                            {models.map((model, idx) => (
                                                ...
                                                >
                                                    ...
                                                    <td className="px-4 py-3">
                                                        <span
                                                            className={`inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-medium capitalize ${model.vehicle_type === "mobil"
                    ...
                    <div className="flex flex-col gap-10">
                        {/* Form Add Service */}
                        <div className="space-y-4 bg-slate-50/50 dark:bg-slate-800/20 p-6 rounded-2xl border border-slate-100 dark:border-slate-800/60">
                            <h2 className="text-lg font-semibold text-slate-950 dark:text-white">
                                Tambah Layanan Baru
                            </h2>
                        ...
                        <div className="space-y-4">
                            ...
                            {isLoadingServices ? (
                                ...
                                <div className="relative overflow-hidden bg-white dark:bg-slate-900 border border-slate-200/60 dark:border-slate-800/60 shadow-xs rounded-2xl">
                                    <div className="overflow-x-auto max-h-150 scrollbar-thin scrollbar-thumb-slate-200 dark:scrollbar-thumb-slate-700">
                                        <table className="w-full text-sm text-left text-slate-600 dark:text-slate-400 border-collapse">
                                            <thead className="text-xs text-slate-500 uppercase sticky top-0 z-10 bg-slate-50/90 dark:bg-slate-800/90 backdrop-blur-md shadow-xs">
                                                <tr>
                                                    <th className="px-6 py-4 font-bold tracking-wider">No.</th>
                                                    <th className="px-6 py-4 font-bold tracking-wider">Informasi Layanan</th>
                                                    <th className="px-6 py-4 font-bold tracking-wider">Kategori</th>
                                                    <th className="px-6 py-4 font-bold tracking-wider text-right">Biaya Reguler</th>
                                                    <th className="px-6 py-4 font-bold tracking-wider text-right">Biaya Express</th>
                                                    <th className="px-6 py-4 font-bold tracking-wider">Terdaftar</th>
                                                </tr>
                                            </thead>
                                            <tbody className="divide-y divide-slate-100 dark:divide-slate-800/80">
                                                {services.map((service, idx) => {
                                                    ...
                                                    // Dynamic badge color based on category text
                                                    let badgeStyle = "bg-indigo-50 text-indigo-700 ring-indigo-600/20 dark:bg-indigo-500/10 dark:text-indigo-400 dark:ring-indigo-500/20";
                                                    const cat = (service.category || "").toLowerCase();
                                                    if (cat.includes("pajak")) {
                                                        badgeStyle = "bg-amber-50 text-amber-700 ring-amber-600/20 dark:bg-amber-500/10 dark:text-amber-400 dark:ring-amber-500/20";
                                                    } else if (cat.includes("mutasi")) {
                                                        badgeStyle = "bg-blue-50 text-blue-700 ring-blue-600/20 dark:bg-blue-500/10 dark:text-blue-400 dark:ring-blue-500/20";
                                                    } else if (cat.includes("balik nama")) {
                                                        badgeStyle = "bg-emerald-50 text-emerald-700 ring-emerald-600/20 dark:bg-emerald-500/10 dark:text-emerald-400 dark:ring-emerald-500/20";
                                                    } else if (cat.includes("payment")) {
                                                        badgeStyle = "bg-purple-50 text-purple-700 ring-purple-600/20 dark:bg-purple-500/10 dark:text-purple-400 dark:ring-purple-500/20";
                                                    }
                                                    ...
                                                    return (
                                                        ...
                                                        >
                                                            ...
                                                            <td className="px-6 py-4 max-w-70">
                                                                <p className="font-bold text-slate-900 dark:text-white truncate transition-colors group-hover:text-blue-600 dark:group-hover:text-blue-400">
                                                                    {service.service_name}
                                                                </p>
                                                                <p
                                                                    className="text-[11px] text-slate-500 dark:text-slate-400 truncate mt-1 leading-relaxed"
                                                            ...
                                                            <td className="px-6 py-4 whitespace-nowrap">
                                                                <span className={`inline-flex items-center px-2.5 py-1 rounded-md text-xs font-bold ring-1 ring-inset ${badgeStyle}`}>
                                                                    {service.category}
                                                                </span>
                                                            </td>
                                                            ...
                                                            <td className="px-6 py-4 whitespace-nowrap text-right">
                                                                <span className="font-bold text-orange-600 dark:text-orange-400 bg-orange-50 dark:bg-orange-900/20 px-2.5 py-1 rounded-md">
